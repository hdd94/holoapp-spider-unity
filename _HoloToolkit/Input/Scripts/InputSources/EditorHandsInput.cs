...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class EditorHandsInput : BaseInputSource
    {
        ...
        [SerializeField]
        [Tooltip("The total amount of hand movement that needs to happen to signal intent to start a manipulation. This is a stopDistance, but not a stopDistance in any one lookDirection.")]
